        ...
        <>
          ...
          <div>
            ...
            <Carousel>
              <div>
                <img
                  src="https://www.lemondedesartisans.fr/sites/lemondedesartisans.fr/files/illustrations/articles/cafe-torrefacteurs.jpg"
                  alt="image1"
                />
              ...
              <div>
                <img
                  src="https://www.lanouvelle.net/wp-content/uploads/sites/41/2021/05/STOREC.jpg"
                  alt="image2"
                />
              ...
              <div>
                <img
                  src="https://img.passeportsante.net/1200x675/2023-02-15/cafe.webp"
                  alt="image5"
                />
            ...
            <div>
              <Row justify="space-between" css={{ marginLeft: "20px" }}>
                <Grid>
                  <Avatar
                    squared
                    src="https://us.123rf.com/450wm/faysalfarhan/faysalfarhan1605/faysalfarhan160504541/57292041-travail-d-%C3%A9quipe-groupe-ic%C3%B4ne-bouton-rond-marron-glac%C3%A9.jpg?ver=6"
                  />
                ...
                <Grid>
                  <Avatar
                    squared
                    src="https://cdn-icons-png.flaticon.com/512/5131/5131594.png"
                  />
                  <h3> PME française</h3>
                </Grid>
                <Spacer x={1} />
                <Grid>
                  <Avatar
                    squared
                    src="https://cdn-icons-png.flaticon.com/512/3476/3476063.png"
                  />
                ...
                <Card css={{ mw: "420px", p: "20px" }}>
                  <Dropdown>
                    ...
                    <Dropdown.Menu aria-label="Static Actions">
                      <Dropdown.Item key="">
                        Voir les capsules Nexpresso
                      </Dropdown.Item>
                      <Dropdown.Item key="">
                        Voir les Dossettes Senseo
                      </Dropdown.Item>
                      <Dropdown.Item key="">
                        Voir les dossettes Tassimo
                      </Dropdown.Item>
                      <Dropdown.Button key="" color="primary" >
                        Tout voir
                      </Dropdown.Button>
                    </Dropdown.Menu>
                  </Dropdown>
              ...
              <Container alignItems="center" justify="center">
                <Card css={{ mw: "420px", p: "20px" }}>
                  <Dropdown>
                    ...
                    <Dropdown.Menu aria-label="Static Actions">
                      <Dropdown.Item key="">
                        Voir les cafés Italiens
                      </Dropdown.Item>
                      <Dropdown.Item key="">
                        Voir les cafés torréfiés en France
                      </Dropdown.Item>
                      <Dropdown.Item key="">Voir les cafés Bio</Dropdown.Item>
                      <Dropdown.Item key="" color="primary">
                        Tout voir
                      </Dropdown.Item>
                    </Dropdown.Menu>
                  </Dropdown>
              ...
              <Container alignItems="center" justify="center">
                <Card css={{ mw: "420px", p: "20px" }}>
                  <Dropdown>
                    ...
                    <Dropdown.Menu aria-label="Static Actions">
                      <Dropdown.Item key="">
                        Voir les auto-broyeurs grains
                      </Dropdown.Item>
                      <Dropdown.Item key="">
                        Voir les Expresso precolateur
                      </Dropdown.Item>
                      <Dropdown.Item key="">
                        Voir les machines nexpresso
                      </Dropdown.Item>
                      <Dropdown.Item key="" color="primary">
                        Tout voir
                      </Dropdown.Item>
                    ...
                    <div>
                      <Row>
                        <Card css={{ mw: "100%", p: "20px" }}>
                          ...
                          />
                          <p>
                            Le café bio est d'excellente qualité. Je vous le
                            recommande
                          </p>
                        </Card>
                        <Spacer x={1} />

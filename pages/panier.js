        ...
        <Card>
          <Card.Body>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
              ...
              <Text style={{ fontSize: "18px", fontWeight: "bold" }}>{calculateTotalPrice()} €</Text>
            </div>
            <Divider />
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
            ...
            <Divider />
            <div>
              <Text style={{ fontSize: "14px", color: "#5d5d5d" }}>Livraison :</Text>
              <Text style={{ fontSize: "14px", color: "#006e92" }}>Offerte en point relais à partir de 69 €</Text>
              <Text style={{ fontSize: "14px", color: "#006e92" }}>Offerte à domicile / bureau à partir de 119 €</Text>
            </div>
            <Divider />
            <div>
              <Text style={{ fontSize: "14px", color: "#5d5d5d" }}>Nous vous répondons avec le sourire :</Text>
              <Text style={{ fontSize: "14px", color: "#006e92", fontWeight: "bold" }}>0988 998 998</Text>
            </div>
